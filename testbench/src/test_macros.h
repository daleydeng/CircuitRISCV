...
#define TEST_CASE( testnum, testreg, correctval, ...) \
test_ ## testnum: \
    li  TESTNUM, testnum; \
    __VA_ARGS__; \
...
#define TEST_FP_OP_H_INTERNAL( testnum, flags, result, val1, val2, val3, ... ) \
test_ ## testnum: \
  li  TESTNUM, testnum; \
...
#define TEST_FP_OP_D32_INTERNAL( testnum, flags, result, val1, val2, val3, ... ) \
test_ ## testnum: \
  li  TESTNUM, testnum; \
  la  a0, test_ ## testnum ## _data ;\
  fld f0, 0(a0); \
...
#define TEST_CASE_D32( testnum, testreg1, testreg2, correctval, ... ) \
test_ ## testnum: \
    __VA_ARGS__; \
